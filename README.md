...
### Live Demo
[Try the web version here](https://your-deployment-url.com) *(deploy the `dist-web/index.html` file)*

### Key Features
- **🖱️ User-friendly interface** - Visual form with helpful descriptions
- **📱 Works anywhere** - Any modern browser, mobile-friendly
- **💾 Offline capable** - Single HTML file, works without internet
- **🎨 Visual feedback** - Real-time validation and progress indicators
- **⚙️ All CLI features** - Same powerful customization options

### Quick Start (Web)
1. Visit the web application URL or open `dist-web/index.html`
...
No installation needed! Just deploy or open the single HTML file:
```bash
# Build the web version
pnpm install
pnpm build:web

# Then deploy dist-web/index.html anywhere, or open it directly in your browser
```
